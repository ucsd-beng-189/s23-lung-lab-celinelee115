...
% figure(3)
plot(beta,Pv_beta,'.',beta,Pabar_beta,'.',beta,PAbar_beta,'.',beta,PI_beta,'.');
title('Partial Pressure of Oxygen vs. Beta');
xlabel('Beta');
ylabel('Partial Pressures');
legend Venous Alveolar Arterial Inspired;
